...
<template>
  <div class="about">
    ...
    <div class="about-body">
      ...
      <van-divider :style="{ color: '#cd1625', borderColor: '#cd1625', fontSize: '20px', fontWeight: 500 }">简介</van-divider>
      ...
      <van-divider :style="{ color: '#cd1625', borderColor: '#cd1625', fontSize: '20px', fontWeight: 500 }">开源地址</van-divider>
      <div>
