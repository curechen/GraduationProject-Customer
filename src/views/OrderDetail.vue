...
<template>
  <div class="order-detail-box">
    ...
    <div class="order-status">
      ...
      <van-button v-if="detail.orderStatus == 3" style="margin-bottom: 10px" color="#cd1625" block @click="handleConfirmOrder(detail.orderNo)">确认收货</van-button>
      <van-button v-if="detail.orderStatus == 0" style="margin-bottom: 10px" color="#cd1625" block @click="showPayFn">去支付</van-button>
